...
while True:
    ...
    try:
        ...
        if seq_num != expected_seq_num:
            print(f"\033[93m{endereco_sender} - Mensagem id {seq_num} recebida fora de ordem, ainda esperando o identificador {expected_seq_num}\033[0m")
            ...
            print(f"\033[92m{endereco_sender} - Mensagem id {seq_num} recebida na ordem, entregando para a camada de aplicação\033[0m")
            mensagem = b"Ok"
